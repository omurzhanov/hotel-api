...
from rooms.views import RoomsViewSet, RoomImageView
...
urlpatterns = [
    ...
    path('v1/api/rooms/', include('rooms.urls')),
    path('v1/api/account/', include('account.urls')),
    path('v1/api/reservation/', include('reservation.urls')),
    path('v1/api/add-image/', RoomImageView.as_view()),
